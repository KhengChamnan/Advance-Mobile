...
class MockRidesRepository extends RidesRepository {
  final List<Ride> _rides = [
    Ride(
      departureLocation: DummyData.fakeLocations[2], //BattamBong
      arrivalLocation: DummyData.fakeLocations[1], // Siem Reap
  ...
  List<Ride> getRides(RidePreference preference, RideFilter? filter) {
    ...
    List<Ride> filteredRides = _rides.where((ride) =>
      ...
      isSameDate(ride.departureDate, preference.departureDate) &&
